...
def load_actual_tomato_data():
    ...
    all_farms_data = {
        ...
        'sales': [32645418, 13500000, 82636320, 22747275, 32739660,
                  ...
                  26169629, 13560000, 19042560, 7537811, 43306320,
                  39933837, 26948409, 25058546, 11700000],
        
        'intermediate_costs': [26374677, 20105980, 47016282, 21176890, 22635520,
                               21562160, 50583113, 22147177, 14848115, 16939450,
                               16759882, 10025438, 21359869, 12154890, 24449898,
                               16713356, 17050062, 23550862, 8925000],
        
        'management_costs': [9616210, 2250000, 18615790, 10307692, 5062500,
                            6720000, 16800000, 7411764, 4640000, 9780000,
                            10145545, 2745000, 10744445, 2692499, 9752631,
                            5215980, 10145545, 6592000, 4925000],
        
        'production_costs': [8946000, 8096042, 8414183, 6543558, 3629701,
                           5420921, 2294308, 7439473, 3697022, 2072584,
                           5017784, 1908440, 5566494, 2344097, 2792843,
                           5223391, 3317784, 1543746, 10045587],
        ...
        'super_efficiency': [0.4796, 1.157, 1.0, 0.3852, 1.0855,
                            1.0, 1.0, 1.0, 1.1912, 0.5103,
                            0.9230, 1.0, 0.3937, 1.0, 1.1719,
                            1.1574, 0.8726, 1.0, 0.5401],
